...
```
2. Place [dataspike_mobile_sdk.aar](https://github.com/dataspike-io/MobileSDK-Android/releases/download/1.0.0-rc6/dataspike_mobile_sdk.aar) in ```libs``` folder in your project.
...
```
4. Initialize SDK in your project as descried above.
